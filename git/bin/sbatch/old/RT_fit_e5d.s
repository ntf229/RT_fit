...
#SBATCH --mem=160GB
#SBATCH --job-name=RT_fit_e5d_wave250_1e8_maxLevel11_DustPedia_inc45-90
...
python /home/ntf229/RT_fit/git/bin/RT_fit_e5d.py \
--dust="True" --maxLevel="11" --wavelengths="250" --numPhotons="1e8" \
--pixels="2000" --fitType="DustPedia" --nwalkers="256"'
